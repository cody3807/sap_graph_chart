		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "AEM Management",
									"targetURL": "#aemmanagementproject1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"aemmanagementproject1-display": {
								"semanticObject": "aemmanagementproject1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=aemmanagement.project1",
									"url": sap.ui.require.toUrl("aemmanagement/project1")
								}
							}
						}
					}
